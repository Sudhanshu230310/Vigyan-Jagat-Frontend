        ...
        <section className="w-full min-h-[60vh] flex flex-col justify-center bg-[#faf9f7] px-6 md:px-12 lg:px-20 py-10">
            ...
            >
                ...
                <div className="relative z-10 max-w-xl">
                    <h2 className="text-2xl md:text-4xl font-lora font-bold text-white tracking-tight leading-snug">
                        Have a question for Shodh<span className='text-cyan-400'>IX</span>?
                    </h2>
                    <p className="mt-3 text-sm font-sans md:text-base text-zinc-50 leading-relaxed">
